...
import { FaExternalLinkAlt, FaArrowRight, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { SiLaravel, SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiNodedotjs, SiMongodb } from 'react-icons/si';
...
const caseStudies: CaseStudyProject[] = [
  {
    ...
    description: 'Multi-payment integration platform transforming lives of vulnerable children and orphans with role-based content management.',
    image: '/images/projects/bridgeofhope/1_bohet-cover.png',
    technologies: [SiLaravel, SiReact, SiTailwindcss],
  ...
  },
  {
    ...
    description: 'Intelligent AI platform with advanced machine learning capabilities for data analysis and automation.',
    image: '/images/projects/ehudai/1_ehudai-cover.png',
    technologies: [SiNextdotjs, SiTypescript, SiNodedotjs],
  ...
  },
  {
    ...
    description: 'Application performance monitoring solution with real-time analytics and comprehensive dashboards.',
  ...
  },
  {
    id: '4',
    title: 'ReveShare',
    subtitle: 'Revenue Platform',
    description: 'Revenue sharing platform with automated distribution and transparent analytics for stakeholders.',
...
const CaseStudyCard: React.FC<{ project: CaseStudyProject }> = ({ project }) => {
  return (
    <div className={`w-full max-w-5xl mx-auto ${project.color} rounded-2xl p-6 sm:p-8 border border-black group hover:shadow-lg transition-shadow duration-300`}>
          ...
          <div className="space-y-5 lg:space-y-6 mt-auto pt-6">
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.slice(0, 5).map((Tech, index) => (
                <div key={index} className="bg-white/80 rounded-full p-2.5 lg:p-3 border border-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-md sm:text-lg lg:text-xl text-paper-muted dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Deep dives into complex projects showcasing problem-solving, technical decisions, and real-world impact
          </p>
        </div>
          ...
          <div className="overflow-hidden mx-12 sm:mx-16">
            ...
            >
              {caseStudies.map((project) => (
                <div key={project.id} className="w-full flex-shrink-0 px-4 sm:px-6">
